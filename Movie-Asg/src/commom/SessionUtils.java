...
public class SessionUtils {
	public static void add(HttpServletRequest request, String name,Object value) {
		...
		session.setAttribute(name, value); // có nghĩa là đẩy giá trí value với cái tên là name lên seccion và nó sẽ tôn tại ở đó
	}
	...
	} // trả về username đã đăng nhập trong hệ thồng
